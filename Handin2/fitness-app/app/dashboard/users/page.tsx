  ...
  if (currentUserRole === "MANAGER") {
    return (
      <div className="flex h-64 flex-col items-center justify-center space-y-4 text-center text-zinc-500">
        ...
        <a href="/dashboard/users/create" className="text-blue-500 underline">Go to Create Trainer</a>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 p-6 font-sans">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">My Clients</h1>
      ...
      {clients.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-zinc-300 py-16 text-center dark:border-zinc-800">
          ...
          <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">No clients yet</h3>
          <p className="mt-2 max-w-sm text-sm text-zinc-500 dark:text-zinc-400">
            It looks like you haven't added any clients to your roster. Add your first client view them in the list.
          </p>
          <a
            href="/dashboard/users/create"
